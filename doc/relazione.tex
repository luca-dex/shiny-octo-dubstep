...
Ci riferiamo ad $(\mathcal{H}(\mathbf{X}), h) $ come allo \textbf{spazio dei frattali}. Mantenendoci al massimo livello di generalità possibile, diciamo che ogni sottoinsieme di $(\mathcal{H}(\mathbf{X}), h)$ è un \textbf{frattale}.
