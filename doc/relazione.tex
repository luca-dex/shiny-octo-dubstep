...
In questo capitolo forniamo un'implementazione didattica dell'algoritmo di compressione usando frattali per permettere di comprenderne gli aspetti pratici . Il codice è stato scritto in linguaggio MATLAB ed è disponibile all'indirizzo \url{github.com/luca-dex/shiny-octo-dubstep}.
