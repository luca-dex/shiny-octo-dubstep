...
Un metodo di partizionamento migliore è quello basato sui \emph{quadtree}. Si divide iniziamente l'immagine in 4 parti, e si controlla il livello di uniformità dei sotto-quadrati. Se il livello di uniformità è entro un limite $e_c$ prefissato, il blocco entra a far parte dell'insieme degli $R_i$. Altrimenti lo si partiziona in 4 parti e si ri-applica nuovamente, ricorsivamente, il procedimento appena descritto.
